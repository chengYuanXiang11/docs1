---
description: "Autopilot aims to break down the barriers between creativity and technical programming, providing equal, simple, and implementable ways for all ideas. Based on AIGCode's self-developed PLE model, we can turn software ideas into truly usable software products through natural language interaction."
title: "👋 Welcom"
---
...
<CardGroup cols="2">
  <Card title="Getting Started" href="https://docs.xxycyx.online/introduction">
    Get your docs set up locally for easy development
  </Card>
  <Card title="Tutorial" href="https://docs.xxycyx.online/introduction">
